...
---
# 排序算法
![](https://raw.githubusercontent.com/QizhengZou/Image_hosting_rep/main/20220220204617.png)
...
归并操作最坏的时间复杂度为： O(n) ，其中 n 是较长数组的长度。归并操作最好的时间复杂度为： O(n) ，其中 n 是较短数组的长度。正是利用这个特点，归并排序先排序较小的数组，再将有序的小数组合并形成更大有序的数组。
